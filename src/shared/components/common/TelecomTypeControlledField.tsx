...
interface telecomTypeControlledFieldProps<Form extends FieldValues> {
  controllerProps: Omit<ControllerProps<Form>, "render"> & {
    schema?: unknown;
  };
}
function TelecomTypeControlledField<Form extends FieldValues>({
  controllerProps,
}: telecomTypeControlledFieldProps<Form>) {
...
export default TelecomTypeControlledField;
