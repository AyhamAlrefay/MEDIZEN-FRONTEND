...
export type ControlledTimeFieldProps<Form extends FieldValues> = Omit<
  TimePickerProps<any>,
...
> & {
  ...
  onChange?: Pick<TimePickerProps<any>, "onChange">["onChange"];
...
/**
 * Description
 * - This component wrap `TimePicker` to make it controlled by React Hook form
 * -
 */
export const ControlledTimeField = <Form extends FieldValues>(
  props: ControlledTimeFieldProps<Form>,
) => {
...
ControlledTimeField.defaultProps = {
  PopperProps: {
    keepMounted: true,
    disablePortal: true,
  },
